...
def estimate_styles(
    ...
    estimates the font size from the bbox height and samples the dominant
    text color from the page image.
    """
    ...
    for region in layout_result.regions:
        ...
        font_size = _estimate_font_size(region.bbox.height, page_image.dpi)
